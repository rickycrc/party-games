...
(function() {
    ...
    var asIcon = function(_ref) {
        ...
        if (transformIsMeaningful(transform) && main.found && !mask.found) {
            ...
            attributes["style"] = joinStyles(_extends({},
                styles,
                {
    ...
    function makeLayersTextAbstract(params) {
        ...
        if (transformIsMeaningful(transform)) {
            styles["transform"] =
                transformForCss({ transform: transform, startCentered: true, width: width, height: height });
 ...
 */
        ...
        disableObservation(function() {
            toArray(root.querySelectorAll("*")).forEach(function(node) {
                [":before", ":after"].forEach(function(pos) {
                    ...
                    if (pseudoElement) {
                        if (pseudoElement.nextSibling &&
                            pseudoElement.nextSibling.textContent.indexOf(DATA_FA_PSEUDO_ELEMENT) > -1) {
    ...
    function onTree(root) {
        ...
        var prefixesDomQuery = ["." + LAYERS_TEXT_CLASSNAME + ":not([" + DATA_FA_I2SVG + "])"].concat(prefixes.map(
            function(p) {
    ...
    var icon = resolveIcons(function(iconDefinition) {
        ...
        return apiObject(_extends({ type: "icon" }, iconDefinition),
            function() {
                ensureCss();
    ...
    var text = function text(content) {
        ...
        return apiObject({ type: "text", content: content },
            function() {
                ensureCss();
